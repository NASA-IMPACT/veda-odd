...
# create security group - don't need to do this more than once
# aws ec2 create-security-group --group-name "launch-wizard-8" --description "launch-wizard-8 created 2025-05-08T15:04:34.591Z" --vpc-id "vpc-0f7268a25f11ea5cc" 
# aws ec2 authorize-security-group-ingress --group-id "sg-preview-1" --ip-permissions '{"IpProtocol":"tcp","FromPort":22,"ToPort":22,"IpRanges":[{"CidrIp":"174.21.145.29/32"}]}' 

export ACCOUNT_ID=
aws ec2 run-instances --image-id "ami-07b0c09aab6e66ee9" --instance-type "r5dn.8xlarge" \
